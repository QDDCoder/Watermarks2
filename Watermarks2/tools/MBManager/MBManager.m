...
#pragma mark - 自定义view使用
+ (void) showCustView:(UIView *) view{
    prestrainView = nil;
    gloomyView.frame = kDefaultRect;
    [gloomyView setBackgroundColor:[UIColor whiteColor]];
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:nil ?:kDefaultView animated:YES];
    hud.customView = view;
...
+ (void) showCustViewWithTimeAndBG:(UIView *) view and:(NSInteger)time{
    prestrainView = nil;
    gloomyView.frame = kDefaultRect;
    [gloomyView setBackgroundColor:[UIColor whiteColor]];
